...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Authentic Thai flavors made fresh in Montrose, Colorado. Call or text to order.",
      },
      { name: "author", content: "Chef Uma's Kitchen" },
      { property: "og:title", content: "Chef Uma's Kitchen — Authentic Thai Food" },
      {
